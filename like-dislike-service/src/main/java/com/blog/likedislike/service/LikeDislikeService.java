...
public class LikeDislikeService {
  ...
  public LikeDislikeDTO createOrToggleLikeDislike(LikeDislikeDTO likeDislikeDTO) {
    ...
    Optional<LikeDislike> existing =
        likeDislikeRepository.findByUserIdAndPostId(
            likeDislikeDTO.getUserId(), likeDislikeDTO.getPostId());
    if (existing.isPresent()) {
      ...
      LikeDislike newLikeDislike =
          new LikeDislike(
              likeDislikeDTO.getUserId(),
              likeDislikeDTO.getPostId(),
              likeDislikeDTO.getLikeDislikeType());
  ...
  private LikeDislikeDTO mapToDTO(LikeDislike likeDislike) {
    return new LikeDislikeDTO(
        likeDislike.getUserId(), likeDislike.getPostId(), likeDislike.getLikeDislikeType());
  }

  public LikeDislikeCountDTO getLikeDislikeCount(Long postId) {

    long likeCount =
        likeDislikeRepository.countByPostIdAndLikeDislikeType(postId, LikeDislikeType.LIKE);
    long dislikeCount =
        likeDislikeRepository.countByPostIdAndLikeDislikeType(postId, LikeDislikeType.DISLIKE);
  ...
  public List<LikeDislikeDTO> getLikeDislikesByPostId(long postId) {
    return likeDislikeRepository.findByPostId(postId).stream().map(this::mapToDTO).toList();
  }
