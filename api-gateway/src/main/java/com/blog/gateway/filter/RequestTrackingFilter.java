...
public class RequestTrackingFilter extends AbstractGatewayFilterFactory<Object> {
        ...
        return chain
            ...
            .doFinally(
                signalType -> {
                  ...
                  trackingService.recordRequestEnd(
                      requestId, method, path, targetService, statusCode, filesInvolved);
                });
      }
  ...
  private List<String> getFilesForPath(String method, String path, String targetService) {
    ...
    if (path.startsWith("/api/posts")) {
      return Arrays.asList(
          "PostController.java", "PostService.java", "PostRepository.java", "Post.java");
    }
